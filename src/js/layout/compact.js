            ...
            while (pass++ < this.settings.maxPass) {
                for (y = 0; y <= (dimensions.height - sprite.height); y++) {
                    for (x = 0; x <= (dimensions.width - sprite.width); x++) {
                        sprite.x = x;
                        sprite.x = util.exactDivision( sprite.x + sprite.padding,sprite.submultiple ) - sprite.padding;
                        sprite.y = y;
                        sprite.y = util.exactDivision( sprite.y + sprite.padding,sprite.submultiple ) - sprite.padding;
